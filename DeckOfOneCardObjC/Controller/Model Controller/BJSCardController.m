...
@implementation BJSCardController

+ (void)drawANewCard:(NSInteger)numberOfCards completion:(void (^)(NSArray<BJSCard *> * _Nullable))completion
{
    ...
    [[[NSURLSession sharedSession] dataTaskWithURL:searchURL completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error) {
        ...
        {
            BJSCard *card = [[BJSCard alloc] initWithDictionary:cardDictionary];
...
+ (void)fetchCardImage:(BJSCard *)card completion:(void (^)(UIImage * _Nullable))completion
{
